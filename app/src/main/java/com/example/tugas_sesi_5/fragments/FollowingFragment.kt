...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getFollowingData(view, username.toString().replace("Username: ", ""))
    }

    private fun getFollowingData(view: View, username: String) {
        ...
        val retrofitData = retrofitBuilder.getFollowingData(username)

        val layoutManager = LinearLayoutManager(context)
        userRecyclerView = view.findViewById(R.id.listFollowing)
